...
class ZMJLoaderButtonProgressView: UIView, ZMJProgressing {
    ...
    lazy var progressView: UIView = {
        ...
        _progressView.backgroundColor = ZMJLoaderButton.loaderButtonColor ?? UIColor.orange
    ...
    func drawCircleBorder() {
        ...
        self.layer.borderColor = ZMJLoaderButton.loaderButtonColor?.cgColor ?? UIColor.orange.cgColor
    ...
    func readyPointAnimation(center: CGPoint) {
        ...
        shap.backgroundColor = ZMJLoaderButton.loaderButtonColor?.cgColor ?? UIColor.orange.cgColor
